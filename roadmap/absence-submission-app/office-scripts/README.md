...
```bash
tsc -p roadmap/absence-submission-app/office-scripts/tsconfig.json
```
...
```bash
tsc -p roadmap/absence-submission-app/office-scripts/tsconfig.test.json
node roadmap/absence-submission-app/office-scripts/run-tests.cjs
```

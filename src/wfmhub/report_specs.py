...
def ensure_report_catalog(home: Path, target: Path | None = None) -> Path:
    ...
    if not target.exists():
        ...
        # known contracts safely when shipped workbook layouts change;
        ...
        known_migrations = {
            ...
            ("2026.09.9", "2026.09.13"),
            ("2026.09.8", "2026.09.13"),
            ("2026.09.7", "2026.09.13"),
            ("2026.09.6", "2026.09.13"),
            ("2026.09.5", "2026.09.13"),
            ("2026.09.4", "2026.09.13"),
            ("2026.09.3", "2026.09.13"),
            ("2026.09.13", "2026.09.14"),
            ("2026.09.12", "2026.09.14"),
            ("2026.09.11", "2026.09.14"),
            ("2026.09.10", "2026.09.14"),
            ("2026.09.9", "2026.09.14"),
            ("2026.09.8", "2026.09.14"),
            ("2026.09.7", "2026.09.14"),
            ("2026.09.6", "2026.09.14"),
            ...
            ("2026.09.8", "2026.09.15"),
            ("2026.09.7", "2026.09.15"),
            ("2026.09.6", "2026.09.15"),
            ("2026.09.5", "2026.09.15"),
            ...
            ("2026.09.9", "2026.09.17"),
            ("2026.09.8", "2026.09.17"),
            ("2026.09.7", "2026.09.17"),
            ("2026.09.6", "2026.09.17"),
        ...
        known_migrations.update(
            (f"2026.09.{version}", "2026.09.20")
            for version in range(3, 20)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.09.21")
            for version in range(3, 21)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.09.26")
            for version in range(3, 26)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.09.27")
            for version in range(3, 27)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.09.28")
            for version in range(3, 28)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.10.1")
            for version in range(3, 29)
        )
        known_migrations.update(
            (f"2026.09.{version}", "2026.10.2")
            for version in range(3, 29)
        )
        known_migrations.add(("2026.10.1", "2026.10.2"))
        known_migrations.update(
            (f"2026.09.{version}", "2026.11.0")
            for version in range(3, 29)
        )
        known_migrations.update({
            ("2026.10.1", "2026.11.0"),

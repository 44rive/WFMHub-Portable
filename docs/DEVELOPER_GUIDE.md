...
Read `WFM_MASTER.md`, `AI_CONTEXT.md`, and `docs/REPORT_DESIGN_SYSTEM.md` before changing source
...
```bash
python3 packaging/windows/build_portable.py --version 0.35.0 --python-version 3.13.7
```

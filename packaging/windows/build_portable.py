...
def validate_stage(stage: Path, expected_native: dict[str, str]) -> None:
    ...
    allowed_root = {
        "WFMHub.cmd", "WEBAPP.cmd", "SETUP.cmd", "UPGRADE.cmd", "README.md", "PROJECT.md", "VERSION.txt",
...
def build(args) -> Path:
    ...
    # Always recreate the entire stage and wheelhouse.
    ...
    shutil.copy2(ROOT / "PROJECT.md", stage / "_system" / "docs" / "PROJECT.md")
